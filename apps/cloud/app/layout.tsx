...
export const metadata: Metadata = {
  metadataBase: new URL('https://mastyf-ai-cloud.vercel.app'),
  title: 'MCP Mastyf AI — Stop AI agents from becoming your next breach vector',
  description:
  ...
  openGraph: {
    title: 'MCP Mastyf AI — Runtime security for MCP',
    description:
