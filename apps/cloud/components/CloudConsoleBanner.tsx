...
/** Clarifies that /dashboard is the cloud console — no self-hosted Guardian required. */
  ...
  return (
    <div className="card" style={{ marginBottom: '1.5rem', borderColor: 'var(--accent, #3b82f6)' }}>
      ...
      <p className="muted" style={{ marginBottom: '0.75rem' }}>
        You are signed in to MCP Guardian Cloud. Edit policy, copy your tenant env snippet, and manage
        API keys here — no local Guardian process required.
      </p>
      <p className="muted" style={{ marginBottom: 0, fontSize: '0.9rem' }}>
        ...
        self-hosted instance: <Link href="/dashboard/connect">Connect self-hosted Guardian</Link>.
      </p>
    </div>
  );
}
