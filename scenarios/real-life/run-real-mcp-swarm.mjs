 ...
 * Usage:
 *   pnpm build
 *   MCP_FS_ROOT=/tmp/mcp-guardian-rl node scenarios/real-life/run-real-mcp-swarm.mjs [--skip-swarm] [--skip-visuals]
 */
...
async function main() {
  ...
  console.log('  Real-life MCP Guardian + Security Swarm');
  console.log('═'.repeat(60));
