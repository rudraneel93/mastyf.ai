...
const md = [
  '# MCP Mastyf AI — Compliance Evidence Summary',
  '',
  ...
  section('Enterprise controls (v2.9.3+)', [
    ...
    '- Response DLP modes: `MASTYF_AI_RESPONSE_DLP_MODE=block|redact|audit`',
    '- SIEM exporter DLQ: `~/.mastyf-ai/exporter-dlq/pending.jsonl`',
    '- Field encryption: `MASTYF_AI_DB_ENCRYPTION_KEY` + optional `MASTYF_AI_DB_ENCRYPTION_SALT`',
    '- JWT max lifetime: `MASTYF_AI_JWT_MAX_LIFETIME_SEC` (default 86400)',
