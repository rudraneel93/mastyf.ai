...
let body = `# MCP Mastyf AI Penetration Test Report
...
2. **E2E proxy** — child process \`mastyf-ai proxy\` with real \`default-policy.yaml\`; blocked calls return JSON-RPC \`-32001\`.
