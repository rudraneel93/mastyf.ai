 ...
 *   - Store in GitHub Secrets as MASTYF_AI_CI_PRIVATE_KEY
 *   - Or save to a file referenced by MASTYF_AI_CI_KEY_FILE
 *
...
async function main() {
  ...
  console.error('═══════════════════════════════════════════════════════');
  console.error('  MCP Mastyf AI — CI Token Keypair');
  console.error('═══════════════════════════════════════════════════════');
  console.error('');
  ...
  console.error('─────────────────────────────────────────────────────');
  console.error('');
  console.error('Store as GitHub Secret: MASTYF_AI_CI_PRIVATE_KEY');
  console.error('Or save to a file and set MASTYF_AI_CI_KEY_FILE=<path>');
  console.error('');
