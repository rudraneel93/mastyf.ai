...
const logPath = join(homedir(), '.mastyf-ai', 'scheduled-analysis.log');
...
console.log('MCP Mastyf AI — scheduled security analysis\n');
console.log('Cron (every Monday 09:00):');
console.log(cronLine);
console.log('\nmacOS launchd (save as ~/Library/LaunchAgents/com.mastyf-ai.analysis.plist):');
console.log(`<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
  <key>Label</key><string>com.mastyf-ai.analysis</string>
...
console.log('\nLoad: launchctl load ~/Library/LaunchAgents/com.mastyf-ai.analysis.plist');
