...
PROBE_WINDOW_S = 60.0
ENUM_WINDOW_S = 120.0
MAX_TIMING_PROBES = int(os.environ.get("MASTYF_AI_MAX_TIMING_PROBES_PER_MIN", "8"))
MAX_ENUM_PROBES = int(os.environ.get("MASTYF_AI_MAX_ENUM_PROBES_PER_SESSION", "20"))
...
def is_timing_guard_enabled() -> bool:
    return os.environ.get("MASTYF_AI_TIMING_GUARD") != "false"
...
def _probe_session_key(ctx: CallContext) -> str:
    tenant = ctx.tenant_id or os.environ.get("MASTYF_AI_TENANT_ID") or "default"
    sub = "anon"
