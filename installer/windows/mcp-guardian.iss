; Inno Setup script — MCP Guardian Windows MSI (build on Windows with Inno Setup 6)
#define MyAppName "MCP Guardian"
#define MyAppVersion "2.7.0"
#define MyAppPublisher "MCP Guardian"
#define MyAppURL "https://github.com/rudraneel93/mcp-guardian"
...
OutputBaseFilename=mcp-guardian-{#MyAppVersion}-win64
Compression=lzma2
...
Source: "..\..\guardian-proxy.ps1"; DestDir: "{app}"
Source: "..\..\scripts\guardian-proxy.ps1"; DestDir: "{app}\scripts"
Source: "..\..\default-policy.yaml"; DestDir: "{app}"
Source: "postinstall-check-node.ps1"; DestDir: "{app}\installer"

[Icons]
Name: "{group}\MCP Guardian Doctor"; Filename: "cmd.exe"; Parameters: "/c node ""{app}\dist\cli.js"" doctor"
