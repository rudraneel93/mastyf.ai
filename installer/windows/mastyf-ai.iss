; Inno Setup script — MCP Mastyf AI Windows MSI (build on Windows with Inno Setup 6)
#define MyAppName "Mastyf AI"
#define MyAppVersion "2.7.0"
#define MyAppPublisher "Mastyf AI"
#define MyAppURL "https://github.com/mastyf-ai/mastyf-ai"
...
OutputBaseFilename=mastyf-ai-{#MyAppVersion}-win64
Compression=lzma2
...
Source: "..\..\mastyf-ai-proxy.ps1"; DestDir: "{app}"
Source: "..\..\scripts\mastyf-ai-proxy.ps1"; DestDir: "{app}\scripts"
Source: "..\..\default-policy.yaml"; DestDir: "{app}"
Source: "postinstall-check-node.ps1"; DestDir: "{app}\installer"

[Icons]
Name: "{group}\MCP Mastyf AI Doctor"; Filename: "cmd.exe"; Parameters: "/c node ""{app}\dist\cli.js"" doctor"
