...
describe('GUARDIAN_DPOP_REDIS_URL', () => {
  const env = { ...process.env };

  beforeEach(() => {
    process.env = { ...env };
    delete process.env.GUARDIAN_DPOP_REDIS_URL;
  ...
  it('prefers GUARDIAN_DPOP_REDIS_URL over REDIS_URL', () => {
    process.env.GUARDIAN_DPOP_REDIS_URL = 'redis://global:6379';
