...
describe('MASTYF_AI_DPOP_REDIS_URL', () => {
  const env = { ...process.env };

  beforeEach(() => {
    process.env = { ...env };
    delete process.env.MASTYF_AI_DPOP_REDIS_URL;
  ...
  it('prefers MASTYF_AI_DPOP_REDIS_URL over REDIS_URL', () => {
    process.env.MASTYF_AI_DPOP_REDIS_URL = 'redis://global:6379';
