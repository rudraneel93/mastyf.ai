...
describe('dashboard threat intel actions', () => {
  ...
  beforeAll(async () => {
    ...
    process.env.MASTYF_AI_THREAT_STATE_PATH = threatStatePath;
    process.env.MASTYF_AI_POLICY_PATH = policyPath;
  ...
  afterAll(async () => {
    ...
    delete process.env.MASTYF_AI_AI_DISABLE_THREAT_POLL;
    delete process.env.MASTYF_AI_THREAT_STATE_PATH;
    delete process.env.MASTYF_AI_POLICY_PATH;
  });
