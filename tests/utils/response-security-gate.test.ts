...
describe('response security gate', () => {
  ...
  beforeEach(() => {
    prev['MASTYF_AI_RESPONSE_DLP_MODE'] = process.env['MASTYF_AI_RESPONSE_DLP_MODE'];
    prev['MASTYF_AI_SEMANTIC_SYNC_RESPONSE'] = process.env['MASTYF_AI_SEMANTIC_SYNC_RESPONSE'];
