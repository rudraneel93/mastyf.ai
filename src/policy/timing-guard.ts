...
const MAX_TIMING_PROBES_PER_SESSION = envInt('MASTYF_AI_MAX_TIMING_PROBES_PER_MIN', 8);
const MAX_ENUM_PROBES_PER_SESSION = envInt('MASTYF_AI_MAX_ENUM_PROBES_PER_SESSION', 20);
...
export function isTimingGuardEnabled(): boolean {
  return process.env['MASTYF_AI_TIMING_GUARD'] !== 'false';
}
