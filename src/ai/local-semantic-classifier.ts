...
const SUSPICIOUS_THRESHOLD = parseFloat(process.env['MASTYF_AI_LOCAL_SEMANTIC_THRESHOLD'] || '0.55');
...
const LOCAL_CACHE_MAX = parseInt(process.env.MASTYF_AI_LOCAL_SEMANTIC_CACHE_MAX || '2048', 10);
