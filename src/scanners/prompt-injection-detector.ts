...
export const INJECTION_RULES: InjectionPattern[] = [
  ...
  { id: 'system-prompt-overridden', severity: 'critical', description: 'System prompt override phrasing',
    regex: '(?:the )?system prompt (?:is |has been )?(?:overridden|replaced|superseded|voided)' },
  { id: 'constraints-never-existed', severity: 'critical', description: 'Safety constraints negation',
