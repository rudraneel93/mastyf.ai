 ...
 *
 * MASTYF_AI_SEMANTIC_STRICT=true — block tools/call when async semantic audit cannot run
 * (no API key / LLM disabled). Mirrors MASTYF_AI_STRICT_MODE patterns in enterprise-bootstrap.
 */
